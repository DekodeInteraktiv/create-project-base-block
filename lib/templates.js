...
const predefinedBlockTemplates = {
	plain: {
		defaultValues: {
			...
			keywords: 'T2',
			npmDevDependencies: [ '@wordpress/block-editor', '@wordpress/i18n' ],
		},
	...
	advanced: {
		defaultValues: {
			...
			description: 'Example block description.',
			keywords: 'T2',
			npmDevDependencies: [ '@wordpress/block-editor', '@wordpress/components', '@wordpress/i18n' ],
		},
		templatesPath: join( __dirname, 'templates', 'advanced' ),
	}
};

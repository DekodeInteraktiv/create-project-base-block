...
const template = {
	...
	choices: [ 'advanced', 'innerblocks', 'plain' ],
};

const viewFiles = {
	type: 'confirm',
	name: 'viewFiles',
	message: 'Would you like to include the view.js and view.css files?',
}

const includeT2 = {
	type: 'confirm',
	name: 'includeT2',
	message: 'Would you like to include the webpack config to load T2 Packages?',
}
